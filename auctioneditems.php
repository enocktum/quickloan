...
<html>
	...
	<body>
		...
		<!-- Main -->
			<div style="width:100%;">
						<center>
						<h1><img width="300" height="80" src="images/auctioned.png" alt="overdue payments"/></h1>
						<p>
						<?php
						include"conn.php";
						...
						if($num)
						{
							while($memberdata=mysqli_fetch_array($query))
							{
								...
								$loanquery=mysqli_query($con,"select * from memberloan where membersid='$membersincre' && soldstatus='1' && approvalstatus='1' && paymentstatus='2' && fineafterdeadline!='0'");
								...
								if($loannumrows>0)
								{
									...
									while($loandata=mysqli_fetch_array($loanquery))
									{
										...
										echo"<tr>
											...
											<td>Ksh.".$loandata['borrowedamount']."</td>
								...
								{
									echo"There are no members that have their items as auctioned.";
								}
							}
						}
						else{
