	...
	<body>
		...
		<!-- Main -->
			<div style="width:100%;">
						...
						if(isset($incre))
						{
							$update=mysqli_query($con,"update memberloan set paymentstatus='1' where incre='$incre'");
							if($update)
							{
								echo'<p>You have marked the customer to have payed the overdue fine successfully.</p>';
							}
							else
							{
